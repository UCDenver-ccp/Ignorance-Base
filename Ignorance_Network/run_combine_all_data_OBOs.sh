...
python3 combine_all_OBOs_data_per_pmcid.py -included_articles=$included_articles -OBO_ontologies=$OBO_ontologies -bionlp_folder=$all_file_path$ignorance_base$automated_data_corpus$obos$concept_system_output -output_folder=$all_file_path$ignorance_base$all_data_corpus$obos$obos_bionlp_files --article_path=$all_file_path$ignorance_base$all_data_corpus$articles


##Combine the best models for OBO_EXT from automated data corpus to put into all data corpus
python3 combine_all_OBOs_data_per_pmcid.py -included_articles=$included_articles -OBO_ontologies=$OBO_EXT_ontologies -bionlp_folder=$all_file_path$ignorance_base$automated_data_corpus$obos$concept_system_output -output_folder=$all_file_path$ignorance_base$all_data_corpus$obos$obos_ext_bionlp_files --article_path=$all_file_path$ignorance_base$all_data_corpus$articles