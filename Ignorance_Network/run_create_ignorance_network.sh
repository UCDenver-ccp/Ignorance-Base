...
python3 preprocess_ignorance_network.py -ignorance_full_graph=$all_file_path$ignorance_base$ignorance_network$all_data_graphs$full_ignorance_graph -pheknowlator_node_info=$all_file_path$ignorance_base$ignorance_network$pheknowlator_node_info -output_path=$all_file_path$ignorance_base$ignorance_network$all_data_graphs