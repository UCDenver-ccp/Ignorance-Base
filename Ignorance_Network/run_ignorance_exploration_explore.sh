...
##all ignorance frequencies in all sentences for the full ignorance graph
true='true'
python3 ignorance_frequencies.py -ignorance_sentence_dict_file=$all_file_path$ignorance_base$ignorance_network$all_data_graphs$all_sentences_dict -ignorance_category_list=$ignorance_ontologies_ordered --all_sentences=$true -output_path=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder

##echo $vitamin_D_ignorance_file_list
###PREPROCESS THE SPECIFIC FILES
python3 ignorance_exploration_explore_preprocess.py -ignorance_full_graph=$all_file_path$ignorance_base$ignorance_network$all_data_graphs$full_ignorance_graph -specific_ignorance_statements_sentence_folder=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder -specific_ignorance_statements_file_list=$vitamin_D_ignorance_file_list -specific_not_ignorance_statements_sentence_folder=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder -specific_not_ignorance_statements_file_list=$vitamin_D_not_ignorance_file_list -preprocess_sentence_dict_path=$all_file_path$ignorance_base$ignorance_network$all_data_graphs$preprocess_sentences_dict -all_sentences_dict_path=$all_file_path$ignorance_base$ignorance_network$all_data_graphs$all_sentences_dict  -output_path=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder --obo_id_list=$obo_id_list_vitamin_D_Teri
...
##IGNORANCE FREQUENCIES just vitamin D sentences
python3 ignorance_frequencies.py -ignorance_sentence_dict_file=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$ignorance_sentence_dict_file -ignorance_category_list=$ignorance_ontologies_ordered -output_path=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder


##TODO: update this with more stuff and rerun!!!
python3 ignorance_exploration_explore_visualizations.py -processed_sentences=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$ignorance_preprocessed_sentence_file -not_processed_sentences=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$not_ignorance_preprocessed_sentence_file -biosent2vec_model_file=$all_file_path$ignorance_base$ignorance_network$biosent2vec_model_file -kmeans_num_clusters=$kmeans_num_clusters -ignorance_sentence_dict_file=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$ignorance_sentence_dict_file -not_ignorance_sentence_dict_file=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$not_ignorance_sentence_dict_file -all_article_summary_file_path=$all_file_path$ignorance_base$all_data_corpus$all_article_summary --obo_id_list=$obo_id_list_vitamin_D_Teri -ignorance_categories=$ignorance_ontologies_ordered -output_path=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$clustering
...
true='true'
python3 ignorance_exploration_explore_word_enrichment.py --obo_id_list=$obo_id_list_vitamin_D_Teri -exposure_name=$exposure_name -exposure_sentence_dict_file="$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$ignorance_sentence_dict_file,$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$not_ignorance_sentence_dict_file" -not_exposure_sentence_dict_file=$all_file_path$ignorance_base$ignorance_network$all_data_graphs$all_sentences_dict --all_sentence_comparison=$true -output_path=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$enrichment$exposure_name/

##preprocessed exposure stuff
#-exposure_processed_sentences="$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$ignorance_preprocessed_sentence_file,$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$not_ignorance_preprocessed_sentence_file" -not_exposure_processed_sentences=$all_file_path$ignorance_base$ignorance_network$all_data_graphs$preprocess_sentences_dict
...
true='true'
python3 ignorance_exploration_explore_word_enrichment.py --ignorance_categories_list=$ignorance_ontologies -exposure_name=$exposure_name -exposure_sentence_dict_file=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$ignorance_sentence_dict_file -not_exposure_sentence_dict_file=$all_file_path$ignorance_base$ignorance_network$all_data_graphs$all_sentences_dict --all_sentence_comparison=$true -output_path=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$enrichment$exposure_name/

##-exposure_processed_sentences=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$ignorance_preprocessed_sentence_file -not_exposure_processed_sentences=$all_file_path$ignorance_base$ignorance_network$all_data_graphs$preprocess_sentences_dict
...
python3 ignorance_exploration_explore_word_enrichment.py --obo_id_list=$obo_id_list_vitamin_D_Teri --word_enrichment_list="$word_enrichment_list" -exposure_name=$exposure_name -exposure_sentence_dict_file=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$ignorance_sentence_dict_file -not_exposure_sentence_dict_file=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$not_ignorance_sentence_dict_file -output_path=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$enrichment$exposure_name/

#-exposure_processed_sentences=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$ignorance_preprocessed_sentence_file -not_exposure_processed_sentences=$all_file_path$ignorance_base$ignorance_network$exploration$vitamin_d_folder$not_ignorance_preprocessed_sentence_file
