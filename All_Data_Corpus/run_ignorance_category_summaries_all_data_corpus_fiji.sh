...
python3 $fiji_path$new_articles_path/ignorance_category_summaries.py -ontologies=$ontologies -algos=$algo -bionlp_path=$fiji_path$ignorance_base_all_data_corpus_path$output_results$bionlp_best_models_folder -sentence_path=$fiji_path$ignorance_base_all_data_corpus_path$pmcid_sentence_files_path -output_path=$fiji_path$ignorance_base_all_data_corpus_path$output_results$ignorance_category_summary_output -evaluation_files=$all_files --article_path=$fiji_path$ignorance_base_all_data_corpus_path$articles