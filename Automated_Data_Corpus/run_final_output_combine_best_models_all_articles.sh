...
mkdir $scratch_path$ignorance_base_corpus$output_results$knowtator_projects$model$underscore$separate_all_combined_output
cd $scratch_path$ignorance_base_corpus$output_results$knowtator_projects$model$underscore$separate_all_combined_output
...
#    do
        ...
        cp $scratch_path$ignorance_base_corpus$output_results$knowtator_best_models_folder/*$annotation_ext$best_algo$annotation_ext2  $concept_annotation
