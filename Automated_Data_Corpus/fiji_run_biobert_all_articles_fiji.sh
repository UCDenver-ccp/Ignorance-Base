...
tokenized_files='Ignorance-Base/Automated_Data_Corpus/Tokenized_Files/'

##the output folder for the results of running BioBERT for span detection
results_span_detection='Ignorance-Base/Automated_Data_Corpus/Word_Analysis_Output_Results/BioBERT_Classification_Results/'
