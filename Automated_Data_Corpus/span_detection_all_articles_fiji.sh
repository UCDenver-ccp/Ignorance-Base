...
#
#
#python3 $all_file_path$eval_path/eval_span_detection.py -ontologies=$ontologies -excluded_files=$all_files -tokenized_file_path=$all_file_path$ignorance_base_path$ignorance_base_corpus$tokenized_files -save_models_path=$all_file_path$save_models_path -algos=$algos -output_path=$all_file_path$ignorance_base_path$ignorance_base_corpus$output_path --pmcid_sentence_files_path=$pmcid_sentence_files_path --gold_standard=$gold_standard #--gs_tokenized_files=$all_file_path$gs_tokenized_files
#
#
...
#biobert='BIOBERT/'
#cp $all_file_path$biobert_classification_train_path$train $all_file_path$ignorance_base_path$ignorance_base_corpus$tokenized_files$biobert
#cp $all_file_path$biobert_classification_train_path$train_dev $all_file_path$ignorance_base_path$ignorance_base_corpus$tokenized_files$biobert
...
python3 $fiji_path$eval_path/eval_span_detection.py -ontologies=$ontologies -excluded_files=$all_files -tokenized_file_path=$scratch_path$ignorance_base_corpus$tokenized_files -save_models_path=$fiji_path$save_models_path -algos=$algos -output_path=$scratch_path$ignorance_base_corpus$output_path --pmcid_sentence_files_path=$pmcid_sentence_files_path --gold_standard=$gold_standard #--gs_tokenized_files=$all_file_path$gs_tokenized_files
...
train_dev='train_dev.tsv'
biobert='BIOBERT/'
cp $fiji_path$biobert_classification_train_path$train $scratch_path$ignorance_base_corpus$tokenized_files$biobert
cp $fiji_path$biobert_classification_train_path$train_dev $scratch_path$ignorance_base_corpus$tokenized_files$biobert