...
#        results_span_detection='Results_span_detection/'
        NER_DIR=$all_file_path$ignorance_base_path$ignorance_base_corpus$tokenized_files$biobert
        OUTPUT_DIR=$all_file_path$ignorance_base_path$ignorance_base_corpus$output_path$i/$biobert
...
#
#            python3 $fiji_path$eval_path/biobert_classification_report.py --ner_conll_results_path=$OUTPUT_DIR/ --biotags=$biotags --ontology=$i --output_path=$OUTPUT_DIR/ --gold_standard=$gold_standard
#
...
#
#            cp $OUTPUT_DIR/biobert_classification_report.txt $scratch_path$ignorance_base_corpus$output_path$i/$i$biobert_class_report
#
#
#
#        fi
...
#    python3 $fiji_path$eval_path/biobert_eval_dataframe_output.py -ontologies=$ontologies -excluded_files=$all_files -tokenized_file_path=$scratch_path$ignorance_base_corpus$tokenized_files -biobert_prediction_results=$scratch_path$ignorance_base_corpus$output_path -output_path=$scratch_path$ignorance_base_corpus$output_path -algos=$algos --pmcid_sentence_files_path=$pmcid_sentence_files_path
