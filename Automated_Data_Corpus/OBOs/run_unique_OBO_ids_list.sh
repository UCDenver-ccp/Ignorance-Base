...
python3 unique_OBO_ids_list.py -ontologies=$ontologies -OBO_file_path=$scratch_path$ignorance_base_all_data_corpus$obos$concept_system_output -evaluation_files=$all_files -output_path=$scratch_path$ignorance_base_all_data_corpus$obos$concept_system_output